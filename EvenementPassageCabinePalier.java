public class EvenementPassageCabinePalier extends Evenement {
    ...
    public void traiter(Immeuble immeuble, Echeancier echeancier) {
        ...
        //SINON SI personne ne veut descendre
            ...
            //SI un ou des passagers veulent monter
            if(étage.aDesPassagers()){
                notYetImplemented();
                //SI veut aller dans la direction de la cabine
                    //ALORS ON OUVRE LES PORTES
                //SINON SI il ne veut pas aller dans la direction de la cabine
                    //alors il attend ce chien
                //FSI
