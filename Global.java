public class Global {
   ...
   /*
    * Cette classe ne doit pas être modifiée. Pour simplifier le code la classe
    * Global est héritée. L'unité de temps est en dixième de secondes dans le type
    * long. Le codage des fichiers est en UTF8. Pour activer assert il faut ajouter
    * l'option -ea avec la commande java.
    */

   static final long tempsPourEntrerOuSortirDeLaCabine = 4;
   /*
    * Il s'agit du temps par personne, si une personne entre et une autre sort, il
    * faut compter deux fois cette durée.
    */
    ...
    * partout dans le reste du code. Sinon, on suppose que la cabine ne dispose pas
    * de capteur de poids en cas de surcharge.
    */
